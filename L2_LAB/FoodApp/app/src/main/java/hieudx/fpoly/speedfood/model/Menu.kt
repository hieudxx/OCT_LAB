...
object Menu {
    private var mainCourseList = ArrayList<Food>()
    private var sideDishesList = ArrayList<Food>()
    private var dessertList = ArrayList<Food>()
    private var beveragesList = ArrayList<Food>()
